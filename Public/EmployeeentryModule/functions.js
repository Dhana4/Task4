...
export function filterRows(employee_array) {
...
export function applyFilters(employee_array) {
...
export function setFiltersActive(value) {
    filtersActiveVar = value;
}
export function buildTable(employee_array) {
...
export function showOptions(event, empNo) {
    ...
    dropdownMenu.querySelector('.view-details').addEventListener('click', function (event) {
        ...
        newWindow === null || newWindow === void 0 ? void 0 : newWindow.document.write(detailsText);
    });
