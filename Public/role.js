...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (rolesAsString) {
        roles_array = JSON.parse(rolesAsString);
    }
    ...
    const selectDropDowns = document.querySelectorAll("#status , #location , #department");
    ...
    const viewAllEmp = document.querySelectorAll('.view-all-emp');
...
function resetFilters(roles_array) {
...
function applyFilters(role_array) {
...
function buildRole(roles_array) {
    ...
    roles_array.forEach(function (role) {
        ...
        employees.slice(0, 4).forEach(employee => {
            ...
            img.src = employee === null || employee === void 0 ? void 0 : employee.profilePic;
